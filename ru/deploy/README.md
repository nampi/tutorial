...
Код загружен на GitHub. Зайди на сайт и проверь! Твой код в отличной компании - [ Django][5], [руководство Django Girls][6] и многих других проектов c открытым исходным кодом на GitHub :)
